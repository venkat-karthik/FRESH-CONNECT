// Renamed to avoid conflict with authenticated dashboard
// You may rename this file to something like public-dashboard.tsx or move it to another route
// For now, rename to page_public.tsx
